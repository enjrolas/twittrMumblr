...
public class twittrMumblr extends PApplet {
...
public ArrayList getTrendingTweets()
{      
...
public void colorFadingBackground()
{
...
static class TextToSpeech extends Object {
  ...
  // Overload the say method so we can call it with fewer arguments and basic defaults
  public static void say(String script, String voice) {
    // 200 seems like a resonable default speed
...
class DisplayTweet {
  ...
  public void display()
  {
    ...
    rotate(angle+(float)frameCount*.001f);
    noStroke();
    fill(tweetColor);
    textSize(48);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "twittrMumblr" };
    if (passedArgs != null) {
